...
<div class="right_col" role="main">
	<div class="">
		...
		<div class="row">
					...
					<div class="x_content">
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<a href="<?php echo $admin_url; ?>kurir/hapus.php?id_kurir=<?php echo $data['id_kurir'];?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
			...
			<div class="col-xs-12">
				<a href="<?php echo $admin_url; ?>kurir/form_tambah.php">
