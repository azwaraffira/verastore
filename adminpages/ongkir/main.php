...
<div class="right_col" role="main">
	<div class="">
		...
		<div class="row">
					...
					<div class="x_content">
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<td><a href="<?php echo $admin_url; ?>ongkir/form_edit.php?id_ongkir=<?php echo $data['id_ongkir'];?>">
								<button class="btn btn-warning">
									<i class="fa fa-edit"></i>
								</button></a>
								
								<a href="<?php echo $admin_url; ?>ongkir/hapus.php?id_ongkir=<?php echo $data['id_ongkir'];?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
			...
			<div class="col-xs-12">
				<a href="<?php echo $admin_url; ?>ongkir/form_tambah.php">
