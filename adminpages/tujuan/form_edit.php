...
$query = mysqli_query($koneksi, "SELECT * FROM tujuan WHERE id_tujuan='$id_tujuan'");
...
include "../templates/header.php"; ?>
      ...
      <!-- page content -->
        <div class="right_col" role="main">
		  ...
		  <input type="hidden" name="id_tujuan" value="<?php echo $dataTujuan['id_tujuan'];?>">
              ...
              <?php } ?>
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12">
                          <input type="text" id="first-name" name="kota" value="<?php echo $dataTujuan['kota']; ?>" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
