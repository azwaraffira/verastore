...
<div class="right_col" role="main">
	<div class="">
		...
		<div class="row">
					...
					<div class="x_content">
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<td><a href="<?php echo $admin_url; ?>tujuan/form_edit.php?id_tujuan=<?php echo $data['id_tujuan'];?>">
								<button class="btn btn-warning">
									<i class="fa fa-edit"></i>
								</button></a>
								
								<a href="<?php echo $admin_url; ?>tujuan/hapus.php?id_tujuan=<?php echo $data['id_tujuan'];?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
			...
			<div class="col-xs-12">
				<a href="<?php echo $admin_url; ?>tujuan/form_tambah.php">
