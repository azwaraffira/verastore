...
$dataKategori = mysqli_fetch_array($query); 
...
include "../templates/header.php"; ?>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Manajemen <small>Data Kategori</small></h3>
              </div>
            </div>
    ...
    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Berat <span class="required">*</span>
		...
		<div class="col-md-10 col-sm-10 col-xs-12">
		  <input type="text" id="first-name" name="berat" value="<?php echo $dataKategori['berat'];?>" required="required" class="form-control col-md-7 col-xs-12">
		</div>
	  </div>
