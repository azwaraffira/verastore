             ...
             <div class="row">
                <div class="col-12 col-md-4 col-lg-3">
                    ...
                    <div class="col-12 col-md-8 col-lg-9">
                        ...
                        <?php
						include "lib/koneksi.php";
                       //$query = "SELECT id_produk, nama, harga, nama_gambar FROM produk order by id_produk WHERE id_produk='$id'";
						$sql = "SELECT id_produk, nama, harga, nama_gambar FROM produk order by id_produk WHERE id_produk = '$id'";
                        $query = mysqli_query($koneksi, $sql);
                        if (!$query) {
                            die ('SQL Error: ' . mysqli_error($koneksi));
                        }
