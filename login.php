       ...
       <div class="register_account">
    	      ...
    	      <h4 class="title">Login</h4>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12">
                          <input type="text" value="Username" id="first-name" name="username" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Username';}" required="required" class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12">
                          <input type="password" id="first-name" value="" name="password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}" required="required" class="form-control col-md-7 col-xs-12">
    			 ...
    			 <!-- <div class="col_1_of_2 span_1_of_2">
		   			 <div><input type="text" value="Nama" name="nama_user" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Nama';}"></div>
		   			 <div><input type="text" value="Telepon" name="telepon" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Telepon';}"></div>
		    			<div><input type="text" value="Alamat" name="alamat" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Alamat';}"></div>
		    			<div><input type="text" value="E-mail" name="email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'E-mail';}"></div>
		    			<div><input type="text" value="Username" name="username" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Username';}"></div>
		    			<div><input type="text" value="Password" name="password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}"></div>
		    	 </div> -->
		    	 <!--  <div class="col_1_of_2 span_1_of_2">	
		    		<div><input type="text" value="Alamat" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Address';}"></div>
