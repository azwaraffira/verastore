<?php
	...
	if ($querySimpan) {
		echo "<script> alert('Data User Berhasil Masuk'); window.location = '$web_url'+'register.php';</script>";
		// jika query gagal, akan tampil alert dan halaman akan diarahkan ke form tambah user
	} else {
		echo "<script> alert('Data User Gagal Dimasukkan'); window.location = '$web_url'+'index.php';</script>";
	}
?>